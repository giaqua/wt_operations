...
frappe.query_reports["Daily Off-Spec Report V3-3 Second Form"] = {
    filters: [
        {
            fieldname: "project",
            label: __("Project"),
...
const PRINT_DATA_METHOD =
    "wt_operations.wt_operations.report.daily_off_spec_report_v3_3_second_form.daily_off_spec_report_v3_3_second_form.get_print_data";
