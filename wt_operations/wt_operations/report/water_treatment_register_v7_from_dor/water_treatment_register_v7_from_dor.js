...
const REPORT_METHOD_PATH =
    "wt_operations.wt_operations.report.water_treatment_register_v7_from_dor.water_treatment_register_v7_from_dor";

frappe.query_reports["Water Treatment Register V7 From DOR"] = {
    filters: [
        {
            fieldname: "project",
            label: __("Project"),
		...
		{
			fieldname: "hide_energy_consumption",
			label: __("Hide Energy Consumption"),
			fieldtype: "Check",
			default: 1,
			description: __("Hides the energy consumption column"),
		}
    ],
